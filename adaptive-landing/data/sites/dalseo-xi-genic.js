...
// 개발사업. 시공 GS건설(주). footer 표기상 시행사는 2026-09-07 현장 요청으로 한 차례 GS건설(주)로
// 정정했다가, 2026-09-14 현장 요청으로 다시 (주)제이비스(대표자 한성민, 사업자번호 240-86-00562)로
// 되돌림 — dalseo-xi-genic-2.js와 동일하게 반영.
...
const config = {
  ...
  signature: {
    ...
    hero: {
      // 2026-09-11 공용 히어로 리뉴얼(우측 슬라이드 썸네일 내비게이션 추가) 이전 구조를 유지하기 위해
      // SignatureHeroLegacy 전용 컴포넌트를 씀 — 다른 현장(공용 SignatureHero)에는 영향 없음
      variant: 'legacy',
