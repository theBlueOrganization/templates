...
//   - 단지 배치도·동호수 배치표·세대 평면도·커뮤니티(CLUB XIAN/CLUB CLOUD) 이미지 — public/apt/osan-heritage-xi-x/에 실제 파일 추가 필요
//   - 히어로/헤더/푸터 로고 이미지
...
const config = {
  ...
  signature: {
    header: {
      logo: { src: '/apt/osan-heritage-xi-x/logo.svg', alt: '오산헤리티지자이', width: 210, height: 47 },
    ...
    hero: {
      ...
      bgImage: { src: '/apt/osan-heritage-xi-x/hero-bg.jpg', alt: '오산헤리티지자이 대표 조감도' },
      bgImageMobile: { src: '/apt/osan-heritage-xi-x/hero-bg-mobile.jpg', alt: '오산헤리티지자이 대표 조감도' },
      mobileBar: {
    ...
    summary: {
      ...
      photo: { src: '/apt/osan-heritage-xi-x/overview-photo.jpg', alt: '오산헤리티지자이 조감도' },
      thumbs: [
        { src: '/apt/osan-heritage-xi-x/overview-thumb-1.jpg', alt: '오산헤리티지자이 단지 전경' },
        { src: '/apt/osan-heritage-xi-x/overview-thumb-2.jpg', alt: '오산헤리티지자이 커뮤니티 시설' },
      ],
    ...
    location: {
      ...
      mapImage: { src: '/apt/osan-heritage-xi-x/location-map.jpg', alt: '오산헤리티지자이 광역 위치 안내도' },
      features: [
        {
          titlePrefix: '',
          ...
          titleSuffix: '',
          tag: 'TRAFFIC',
          image: { src: '/apt/osan-heritage-xi-x/feature-traffic.jpg', alt: 'GTX-C 노선 수혜' },
          descStrong: '',
        ...
        },
        {
          ...
          titleSuffix: '',
          tag: 'LIFE',
          image: { src: '/apt/osan-heritage-xi-x/feature-life.jpg', alt: '병점생활권 인프라' },
          descStrong: '',
        ...
        },
        {
          ...
          titleSuffix: '',
          tag: 'COMMUNITY',
          image: { src: '/apt/osan-heritage-xi-x/feature-community.jpg', alt: '대단지 커뮤니티' },
          descStrong: '',
        ...
        },
        {
          ...
          titleSuffix: '',
          tag: 'BRAND',
          image: { src: '/apt/osan-heritage-xi-x/feature-brand.jpg', alt: '자이 브랜드 프리미엄' },
          descStrong: '',
    ...
    premiumIntro: {
      ...
      bgImage: { src: '/apt/osan-heritage-xi-x/premium-intro-bg.jpg', alt: '오산헤리티지자이 프리미엄 전경' },
    },
    ...
    complex: {
      ...
      siteMap: {
        image: { src: '/apt/osan-heritage-xi-x/complex-sitemap.jpg', alt: '오산헤리티지자이 단지 배치도', width: 1318, height: 1732 },
      },
      donghoChart: {
        image: { src: '/apt/osan-heritage-xi-x/complex-dongho-chart.jpg', alt: '오산헤리티지자이 동호수 배치표', width: 1433, height: 1920 },
      },
    },
          ...
          types: [
            {
              ...
              image: { src: '/apt/osan-heritage-xi-x/unit-59a.jpg', alt: '오산헤리티지자이 59㎡A 타입 평면도' },
          ...
          types: [
            {
              letter: 'A',
              countText: '평형 스펙 확인 필요',
              image: { src: '/apt/osan-heritage-xi-x/unit-84a.jpg', alt: '오산헤리티지자이 84㎡A 타입 평면도' },
              specs: { exclusive: '0.0000', common: '0.0000', supply: '0.0000', otherCommon: '0.0000', contract: '0.0000' },
            },
          ],
        },
    ...
    club: {
      ...
      variant: 'simple',
      plainImage: {
        src: '/apt/osan-heritage-xi-x/club-xian-cloud-full.jpg',
...
4. 동의 거부권 및 미동의 시 불이익 - 귀하는 위와 같은 개인정보 수집 및 이용에 대한 동의를 거부할 권리가 있습니다. 단, 필수 항목 수집에 동의하지 않으실 경우, 견본주택 방문 예약 및 원활한 상담, 분양 정보 수신 등의 서비스 제공이 제한될 수 있습니다.`,
    ...
    footer: {
      logo: { src: '/apt/osan-heritage-xi-x/footer-logo.png', alt: '오산헤리티지자이' },
