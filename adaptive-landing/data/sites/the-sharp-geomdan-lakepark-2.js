...
const config = {
  ...
  // 요청 반영 — 매체별 유입경로 5종(엘포인트/SKT×2/신한×2). SKT·신한은 링크가 2개씩이라
  // 드롭다운에서 구분되도록 라벨에 번호를 붙임(SKT/SKT2, 신한/신한2) — sungui-raon-private-skyve.js와 동일 방식
  utmSources: [
  ...
  // utm_source=lpoint/SKT/SKT2/sh/sh2로 들어온 방문자에게만 화면 문의처 번호를 다르게 표시
  // (sh는 기존 링크로, telNumber 기본값 1800-2261과 동일)
  telNumberByUtm: {
    lpoint: '1522-8602',
    SKT: '1666-1050',
    SKT2: '1800-2261',
  ...
  // 상담 접수 문자의 현장명 뒤에 "+매체명"을 붙여서 유입경로별로 구분 (예: "[더샵 검단레이크파크2 +신한] 신규 상담 신청")
  smsProjectNameByUtm: {
    lpoint: '엘포인트',
    SKT: 'SKT',
    SKT2: 'SKT2',
  ...
  // 유입경로별 상담 접수 SMS 수신번호 — 엘포인트만 김나경 추가, 나머지(SKT/SKT2/신한/신한2)는
  // 최현정·이수지·진의원 3명 동일 (기본 adminPhones와 동일 구성)
  adminPhonesByUtm: {
    ...
    sh: ['01090447402', '01048086474', '01071901052'],
    sh2: ['01090447402', '01048086474', '01071901052'],
  },
