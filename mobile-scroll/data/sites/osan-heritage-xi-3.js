/**
 * 현장 슬러그: osan-heritage-xi-3
 * URL: /apt/osan-heritage-xi-3
...
const config = {
  slug:        "osan-heritage-xi-3",
  subdomain:   "osan-heritage-xi",
  projectName: "오산헤리티지자이",
  shortName:   "오산헤리티지자이",
  telNumber:   "1866-1035",
  ogImage:     "/apt/osan-heritage-xi-3/share_img.png",
  adminPhones:  ["01083909155"],
  kakao:        true,
  ...
  popup: {
    enabled: true,
    image: {
      src: "/apt/osan-heritage-xi-3/popup.webp",
      alt: "오산헤리티지자이 팝업",
    },
  },
  ...
  hero: {
    ...
    brand:         "오산헤리티지자이",
    title:         "병점X동탄 더블생활권\n1만세대 미니신도시급\n오산 최초 프리미엄 브랜드",
    subtitle:      " 문의) 1866-1035",
    bgColor:       "#1e293b",
    accentKeyword: ["병점X동탄", "역세권", "프리미엄 브랜드"],
    image: {
      src:    "/apt/osan-heritage-xi-3/main2.webp",
      alt:    "오산헤리티지자이 대표 이미지",
      width:  750,
      height: 500,
    },
  ...
  sections: [
      ...
      tabs: [
        {
          label: "1단지",
          images: [
            { src: "/apt/osan-heritage-xi-3/1-1.webp", alt: "사업개요 1단지" },
          ],
          specItems: [
        ...
        },
        {
          label: "2단지",
          images: [
            { src: "/apt/osan-heritage-xi-3/1-2.webp", alt: "사업개요 2단지" },
          ],
          specItems: [
    ...
    },
    {
      ...
      images: [
        { src: "/apt/osan-heritage-xi-3/1-3.webp", alt: "입지환경" },
      ],
    },
    {
      id:       "premium",
      ...
      images: [
        { src: "/apt/osan-heritage-xi-3/2-1.webp", alt: "프리미엄" },
      ],
    },
    {
      ...
      images: [
        { src: "/apt/osan-heritage-xi-3/2-2.webp", alt: "단지설계" },
      ],
    },
    {
      id:       "community",
      ...
      images: [
        { src: "/apt/osan-heritage-xi-3/3-1.webp", alt: "커뮤니티" },
      ],
    },
    {
      id:       "complex",
      ...
      images: [
        { src: "/apt/osan-heritage-xi-3/3-2.webp", alt: "평면도 75~84C" },
        { src: "/apt/osan-heritage-xi-3/3-2b.webp", alt: "평면도 84D~166P" },
      ],
    },
  ],
